...
function makeResourceName (service: string, givenName: string, alarm: string) {
 ...
 * @returns Literal string or Sub variable syntax
 */
function resolveLoadBalancerFullNameForSub (logicalId: string) {
 ...
 * @returns Literal string or Sub variable syntax
 */
function resolveTargetGroupFullNameForSub (logicalId: string) {
 ...
 */
function resolveRestApiNameAsCfn (restApiResource, restApiLogicalId: string) {
 ...
 * @returns Literal string or Sub variable syntax
 */
function resolveRestApiNameForSub (restApiResource, restApiLogicalId: string) {
